...
protected_lakes_by_state_80pct <- function(NHD_pts_lakes_PADUS, lower48){
  ...
  lower48_lakes_bystate_gap12_Cat80 <- colSums(gContains(lower48, protected_lakes_gap12_Cat80, byid = T))
  lower48_lakes_bystate_gap3_Cat80 <- colSums(gContains(lower48, protected_lakes_gap3_Cat80, byid = T))
  ...
  lower48_protected_lakes_DF <- data.frame(State=lower48_names, ProtectedLakes_gap12_ctr=lower48_lakes_bystate_gap12_ctr,
                                           ...
                                           ProtectedLakes_gap12_Cat80=lower48_lakes_bystate_gap12_Cat80,
                                           ProtectedLakes_gap3_Cat80=lower48_lakes_bystate_gap3_Cat80,
  ...
  lake_countz_protected_lower48$PropProtected_gap12_Cat80 <- lake_countz_protected_lower48$ProtectedLakes_gap12_Cat80/lake_countz_protected_lower48$nLakes
  lake_countz_protected_lower48$PropProtected_gap3_Cat80 <- lake_countz_protected_lower48$ProtectedLakes_gap3_Cat80/lake_countz_protected_lower48$nLakes
  ...
  lower48_lakes_bystate_gap12_Cat80 <- NULL
  lower48_lakes_bystate_gap3_Cat80 <- NULL
